...
function makeErrorPayload({ message }: Error) {
...
export const response = {
    ...
    error: (cause: unknown, options: ResponseOptions) => {
        ...
        return json(makeErrorPayload(reason), makeOptions({ ...options }));
    },
    ...
    deferError: (cause: unknown, options: ResponseOptions) => {
        ...
        return defer(makeErrorPayload(reason), makeOptions({ ...options }));
    },
